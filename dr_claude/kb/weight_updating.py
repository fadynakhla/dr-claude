"""This script is used to update the condition-symptom weights using Claude.

poetry run python dr_claude/kb/weight_updating.py --input_csv_path <in_path> --output_path <out_path>
"""
...
def main(
    input_csv_path: str = "data/NYPHKnowldegeBase.html",
    output_path: str = "data/ClaudeKnowledgeBase-1.csv",
) -> None:
    ...
    reader = kb_reading.NYPHKnowldegeBaseReader(input_csv_path)
    ...
    kb_to_dataframe(weight_updated_kb).to_csv(output_path)
